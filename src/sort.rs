...
// use crate::cmov::oblivious_conditonal_swap;
...
//     oblivious_conditonal_swap(choice, a, b);
// }
...
// {
//     unsafe { 
//         bitonic_sort_inner(array, 0, array.len(), &mut cmp, true) 
//     }
// }
...
// #[inline]
// pub fn bitonic_merge_sorted_iters<T: Clone + Ord>(
...
// #[inline]
// pub fn bitonic_merge_sorted_slices<T: Clone + Ord>(left: &[T], right: &[T]) -> Vec<T> {
//     assert_eq!(
//         left.len(),
//         right.len(),
